    ...
    recipe: {
      ...
      overlays: [
        ...
        textOverlay({
          ...
          trackType: "text",
          timing: full,
          transform: transform(0.1, 0.06, 1, 1, 0, 0, 0.5),
          content: {
            text: "REC",
            style: { fontFamily: "Inter", fontSize: 20, color: "#ff4d4d", fontWeight: 700, textAlign: "left", verticalAlign: "middle", lineHeight: 1.1, letterSpacing: 1 },
          },
        }),
        textOverlay({
          type: "text",
